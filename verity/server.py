...
class Handler(BaseHTTPRequestHandler):
    ...
    def _send(self, code: int, obj: dict):
        ...
        try:
            ...
            # Health probes and hooks have strict timeouts. If a client closes after the
            # response was computed, that is not a daemon failure and should not flood
            # launchd's persistent log with misleading tracebacks.
            return
